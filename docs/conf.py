...
sys.path.insert(0, os.path.abspath('../urbanmetabolism/'))
...
extensions = ['sphinx.ext.todo' , 'sphinx.ext.autodoc', 'sphinx.ext.mathjax', 'sphinx.ext.graphviz', 'sphinx.ext.napoleon']
# extensions = ['sphinx.ext.todo' , 'sphinx.ext.autodoc', 'sphinx.ext.pngmath']
...
htmlhelp_basename = 'Spatial Microsimulation Unrban Metabolism'
