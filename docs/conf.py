# -*- coding: utf-8 -*-
#
# SMUM configuration file, created by
# Esteban on 26.01.2017
#
...
# sys.path.insert(0, os.path.abspath('/home/esteban/workspace/python/urbanmetabolism_repo/urbanmetabolism/'))
sys.path.insert(0, os.path.abspath('../smum/'))
...
# work-around for ipython3 pygments:
...
author = u'Dr. Esteban Muñoz'
publisher = u'UN Environment'
project = u'Spatial Microsimulation Urban Metabolism (SMUM)'
copyright = u'2017-2018, ' + author
...
.. only:: html
    ...
    .. nbinfo::
        ...
        :raw-html:`<a href="http://nbviewer.jupyter.org/github/emunozh/um/blob/master/docs/example_be/{{ docname }}"><img alt="Binder badge" src="https://img.shields.io/badge/render-nbviewer-orange.svg"></a>`
.. raw:: latex
...
html_title = "Spatial Microsimulation Urban Metabolism"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "SMUM"
...
htmlhelp_basename = 'Spatial Microsimulation Urban Metabolism'
...
epub_author = u'Dr. Esteban Muñoz'
epub_publisher = u'UN Environment'
epub_copyright = u'2017-2018, Dr. Esteban Muñoz'
